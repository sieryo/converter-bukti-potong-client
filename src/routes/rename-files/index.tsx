...
function RouteComponent() {
    ...
    const [renameMode, setRenameMode] = useState<"by_category" | "by_nama_pegawai">("by_category");
    ...
    const missingPegawaiMapping = byPegawaiMode && (!mappingFile || !sheetName.trim());
    ...
    return (
        <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,_#dffaf0_0%,_#f4fbff_42%,_#f8fafc_100%)] p-4 md:p-8">
            <FullscreenLoader />
                        ...
                        {jobId && (
                            <div className="p-4 bg-white rounded-2xl border border-cyan-200 shadow-sm mb-4">
                                <div className="flex items-center justify-between gap-2 mb-2">
                                    <p className="text-sm text-gray-500 font-medium uppercase tracking-wider">Job ID</p>
                                    <Button
                                        type="button"
                                        variant="ghost"
                                        size="sm"
                                        onClick={copyJobId}
                                        className="h-7 px-2 text-cyan-700 hover:text-cyan-800 hover:bg-cyan-50"
                                    >
                    ...
                    <div className="lg:col-span-5 space-y-6">
                        ...
                        <div className="rounded-2xl border border-gray-200 bg-white/80 backdrop-blur-sm p-5">
                            ...
                            <ol className="mt-3 space-y-1.5 text-sm text-gray-600 list-decimal pl-4">
                                ...
                                <li>Pantau progress dan download hasil ketika selesai.</li>
                            </ol>
                        </div>
                    </div>
                </div>
